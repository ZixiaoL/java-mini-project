...
public class RoastedSweetPotato extends AbstractRecipe implements Recipe {
    ...
    private static final int DEFAULT_ROASTED_SWEET_POTATO_VOLUME_CUBIC_INCHES = 6000;

    private static final double TIME_DEVIDED_BY_OVEN_TEMPERATURE_FOR_ROASTED_SWEET_POTATO_IN_MINUTES = 0.1;
	...
	if(oven != null){
	    remainingSecondsUntilDone[0] = TIME_DEVIDED_BY_OVEN_TEMPERATURE_FOR_ROASTED_SWEET_POTATO_IN_MINUTES * oven.getSetTemperature() * 60;
	...
	return DEFAULT_ROASTED_SWEET_POTATO_VOLUME_CUBIC_INCHES;
    }
